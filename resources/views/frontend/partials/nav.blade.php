              ...
              <nav class="site-navigation text-right" role="navigation">
                <div class="container pr-0">
                  ...
                  <ul class="site-menu js-clone-nav d-none d-lg-block">
                    ...
                    @if (!Auth::check())
                    <li class="{{ request()->routeIs('/register') ? 'active' : '' }}"><a href="/register"> Register As Job Seeker</a></li>
                    <li class="{{ request()->routeIs('employer.register') ? 'active' : '' }}"><a href="{{ route('employer.register') }}">Register As Employer</a></li>
                    @else
